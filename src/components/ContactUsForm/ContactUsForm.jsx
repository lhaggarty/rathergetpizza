...
const rootClass = 'contact-us-form';
...
class ContactUsForm extends React.Component {
  ...
  render() {
    ...
    const messages = {
      ...ContactUsForm.defaultProps.messages,
      ...this.props.messages,
  	};
    const { status } = this.state;
    return (
      <form onSubmit={this.handleSubmit.bind(this)} className={`${className} ${rootClass}`}>
        {fields.map( (input,key) => (
		<div className={this.props.fieldParentClassName} key={key}>
			{ input.field === 'textarea' &&
				<textarea
	  			...
	  			className={input.className ? `${this.props.fieldClassName} ${input.className}` : this.props.fieldClassName}
	            />
			}
			{ input.field !== 'textarea' &&
				<>
...
ContactUsForm.propTypes = {
  ...
  fieldParentClassName: PropTypes.string,
